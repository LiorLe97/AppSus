  ...
  render() {
    ...
    return (
      <section className="mail-app flex">
        ...
        {!isCompose && <MailsList mails={mails} onSortBy={this.onSortBy} onToggleStaring={this.onToggleStaring} history={this.props.history} onReadEmail={this.onReadEmail} filterBy={filterBy} onToggleReadEmail={this.onToggleReadEmail} />}
